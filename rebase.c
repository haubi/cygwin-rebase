...
"use the -8 option.\n", progname, db_file);
  ...
  if (ret == 0)
	 ...
	 *  --oblivious or --register is active, even if they are
...
{
  /* While --oblivious or --register is active, cannot_rebase
...
"\n\
  ...
  -O, --oblivious         Do not change any files already in the database\n\
                          ...
                          (Implies -s).\n\
  -R, --register          Do not perform any rebase, update the database only.\n\
